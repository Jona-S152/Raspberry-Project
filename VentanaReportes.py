...
class Reporte:
    ...
    def __init__(self):
        ...
        self.cal = Calendar(self.panelCalendario, selectmode='day', locale='en_US', disabledforeground='red',
               ...
               font=cal_font)
        self.cal.grid(row=1, column=0, padx=33, pady=40)
        ...
        self.treeview.column("ID", width=50)  # Ancho de la columna ID
        self.treeview.column("Producto", width=150)  # Ancho de la columna Producto
        self.treeview.column("Cantidad", width=50)  # Ancho de la columna Cantidad
        self.treeview.column("Total", width=50)  #Ancho de la columna Total
        self.treeview.column("Fecha", width=150)  #Ancho de la columna Fecha
